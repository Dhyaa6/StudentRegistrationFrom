...
namespace StudentRegistrationFrom
{
    public partial class frmRegistration : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill in at least Name and Email before saving!",
                "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                picStudent.Image = System.Drawing.Image.FromFile("student_picture.jpg");
            }
            else
            {
                picStudent.Image = null;
        ...
        private void cmbCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selected country: " + cmbCountry.SelectedItem.ToString());
            }
        }
